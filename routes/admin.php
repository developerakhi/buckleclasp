...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    Route::controller(CategoryController::class)->group(function () {
        ...
        Route::post('/categories/newstatus', 'updateNewStatus')->name('categories.new_status');
    });
...
Route::controller(CustomizationController::class)->group(function () {
        // All Orders
        Route::get('/all_customization', 'all_customization')->name('all_customization.index');
        Route::get('/show_customization/{id}', 'show')->name('all_customization.show');
        Route::get('/all_customization/destroy/{id}', 'destroy')->name('all_customization.destroy');
});
