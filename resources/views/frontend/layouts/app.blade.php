...
<head>
    ...
    <meta name="google-site-verification" content="UE4U2qhq3zGB__1giNtYIWNHnYq9fIy1C3341Fk02Ek" />  <!-----  meta tag for rumi madum --->
    
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-T0R1C77NR8"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());
    
      gtag('config', 'G-T0R1C77NR8');
    </script>
    ...
    <meta name="image" content="https://sogo.com.bd/public/uploads/all/PdmdKEEsFyF3NVg27uws11zauUUV99wRunchp9GH.png">
    ...
    @endif
    <!--<link rel="stylesheet" href="{{ static_asset('assets/css/style.scss') }}">-->
