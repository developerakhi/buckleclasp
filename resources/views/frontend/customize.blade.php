                ...
                <div class="col-xl-9 order-xl-1">
                    ...
                    <div class="row gutters-16 mb-4">
                        <div class="col-5 col-xl-6">
                            <h1 class="fw-700 fs-20 fs-md-24 text-dark mb-0">{{ translate('Customization')}}</h1>
                        </div>
                        <div class="col-5 col-xl-6">
                            <ul class="breadcrumb bg-transparent p-0 justify-content-end">
                                ...
                                <li class="text-dark fw-600 breadcrumb-item">
                                   <a class="text-reset" href="{{ route('customize') }}"> "{{ translate('Customization') }}"</a>
                                </li>
                            </ul>
                        </div>
                </div>
                        ...
                        <div class="card-body">
                            <div class=row>
                                <div class="col-md-6 col-sm-4 col-lg-6">
                                    <div class="img">
                                        <img src="public/assets/img/CRM-Experience.png"/ style="width:100%; height: 530px;">
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-4 col-lg-6">
                                    <form role="form" action="{{ route('customize-store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
