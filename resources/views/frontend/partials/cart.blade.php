...
<a href="javascript:void(0)" class="d-flex align-items-center text-reset h-100" data-toggle="dropdown"
    ...
    <span class="flex-grow-1 ml-1">
        @if (isset($cart) && count($cart) > 0)
            <span class="mrl15 badge badge-primary badge-inline badge-pill cart-count">
                {{ count($cart) }}
            </span>
        @else
            <span class="mrl15 badge badge-primary badge-inline badge-pill cart-count">0</span>
        @endif
        <span class="nav-box-text d-none d-xl-block"> <img src="https://buckleclasp.com/public/uploads/all/1fGnXh9oUqPnQt1fpiRBaHYTD1A786tHAhsB5FZb.svg" alt="My Bag" title="My Bag" width="48px" height="48px" class="iconstyled__IconImg-sc-119344p-1 bIuKIn"></span>
    </span>
</a>
