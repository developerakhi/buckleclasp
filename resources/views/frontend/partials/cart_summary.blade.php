<div class="card rounded border-0 shadow-sm">
    ...
    <div class="card-body">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                @foreach ($carts as $key => $cartItem)
                    @php
                        $product = \App\Models\Product::find($cartItem['product_id']);
                        $subtotal1 += cart_product_price($cartItem, $product, false, false) * $cartItem['quantity'];
                        ...
                        if($total_qty >= 2 ) {
                         ...
                         $subtotal = $subtotal1 - $subtotal1 * $sp_discount / 100;
                         $special_discount = $subtotal1 * $sp_discount / 100;
        ...
        <input type="hidden" name="special_discount" value="{{ $special_discount }}">
        ...
        <table class="table">
            <tfoot>
                <tr class="cart-subtotal">
                    ...
                    <td class="text-right">
                        <span class="fw-600">{{ single_price($subtotal1) }}</span>
                    </td>
                </tr>
                ...
                <tr class="cart-total">
                    ...
                    <td class="text-right">
                        ৳<strong id="totalcost"><span>{{ ($total) }}</span></strong>
                    </td>
                </tr>
