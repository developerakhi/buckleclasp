                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 col-lg-6">
                        <div class="text-left">
                            ...
                            <hr style="margin-top:0rem; margin-bottom:0rem; border-top: 1px solid rgba(0,0,0,.0);">
                            ...
                            <hr style="margin-top:0rem; border-top: 1px solid rgba(0,0,0,.0);">
                            ...
                            <form id="option-choice-form">
                                ...
                                <div class="row no-gutters">
                                    ...
                                    <div class="" id="chosen_price_div" style="margin-top:5px;">
                                       <div class="opacity-50" style="float:left; margin-top: 5px;">{{ translate('Total Price') }}:</div>
                                       <div class="product-price" style="float:right; margin-left: 20px;">
                            ...
                            <hr>
                            <!--<div class="mt-3">-->
                            <!--    <p>Fabrilife Men's Premium Quality Sports t-shirts are smooth and comfortable. The t-shirts are made with the finest quality polyester fabric, perfect for casual or sports wear.</p>-->
                            <!--</div>-->
                            ...
                            <!--<div class="self-product-description">-->
                                ...
                                <!--</ul>-->
                                <!--<table border="1" width="439" cellpadding="5">-->
                                <!--    <thead>-->
                                <!--        <tr>-->
                                <!--            <th style="text-align: center;">Size</th>-->
                                <!--            <th style="text-align: center;">Chest (Round)</th>-->
            ...
            <div class="row gutters-10">
                <div class="col-xl-3 order-1 order-xl-0">
                    ...
                    <div class="bg-white rounded shadow-sm mb-3">
                        ...
                        <div class="" style="padding-bottom: 86px; padding-left: 20px; padding-right: 20px;">
                            <ul class="list-group list-group-flush">
                                @foreach (filter_products(\App\Models\Product::where('user_id', $detailedProduct->user_id)->orderBy('num_of_sale', 'desc'))->limit(2)->get()
        as $key => $top_product)
