        ...
        <div class="card">
            <div class="card-body p-0">
                ...
                <form class="p-4" action="{{ route('categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label">
                            {{translate('New Status Ordering Number')}}
                        </label>
                        <div class="col-md-8">
                            <input type="number" name="new_status_level" value="{{ $category->new_status_level }}" class="form-control" id="new_status_level" placeholder="{{translate('new status level')}}">
                            <small>{{translate('Higher number has high priority')}}</small>
                        </div>
                    </div>
                    <div class="form-group row">
