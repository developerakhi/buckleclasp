    ...
    public function store(Request $request)
    {
        ...
        foreach ($seller_products as $seller_product) {
            ...
            foreach ($seller_product as $cartItem) {
                ...
                $singleprice = $cartItem['price']*$cartItem['quantity'];
				$bKash_discount += $singleprice * 20 / 100;
            ...
            if($total_qty >= 2){
                $special_discount = $subtotal - $subtotal * 0 / 100;
                $order->grand_total = $special_discount + $tax + $shipping;
            }else{
