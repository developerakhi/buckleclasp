...
class HomeController extends Controller
{
    ...
    {
         $featured = Category::where('new_status',1)->orderBy('new_status_level', 'ASC')->get();
        ...
        return view('frontend.index', compact('featured_categories', 'todays_deal_products', 'newest_products','featured'));
    }
